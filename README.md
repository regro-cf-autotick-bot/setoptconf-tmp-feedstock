...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/setoptconf-tmp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14966&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/setoptconf-tmp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `setoptconf-tmp` can be installed with:

```
conda install setoptconf-tmp
```

It is possible to list all of the versions of `setoptconf-tmp` available on your platform with:
